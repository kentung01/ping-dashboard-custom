import { Registry, NameService, MatchaError, MatchaErrorType, services, allowedTopLevelDomains, AllowedTopLevelDomains, Network, RpcURLs } from './registry';
/**
...
export type { Registry, NameService, MatchaError, MatchaErrorType, AllowedTopLevelDomains, Network, RpcURLs };
